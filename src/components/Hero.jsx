...
export default function Hero() {
  return (
    <section id="hero" className="h-screen flex items-center justify-center bg-deep-teal-200 py-20">
      <div className="max-w-3xl text-center p-10 bg-deep-teal-800 text-white rounded-3xl shadow-lg">
