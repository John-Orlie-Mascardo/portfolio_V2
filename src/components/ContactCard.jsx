        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-alabaster-grey-600">johnmascardo@email.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-alabaster-grey-600">+63 912 345 6789</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[ 
                  ...
                  { name: 'Discord', icon: 'discord', color: 'hover:text-indigo-600' }
                ].map((social) => (
                  <a 
                    key={social.name} 
                    href="#" 
                  ...
                  >
                    <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {social.icon === 'discord' && (
                          <path fillRule="evenodd" d="M23.21 12.073c-.008.179-.015.358-.022.537a10.4 10.4 0 01-2.935 7.816 10.5 10.5 0 01-1.636 1.194c-.161.093-.327.18-.494.263a1 1 0 01-1.127 0c-.167-.083-.333-.17-.494-.263-.502-.296-1.038-.617-1.604-1.194-1.15-1.228-2.01-2.822-2.487-4.64h-.012c-.478 1.818-1.338 3.412-2.487 4.64a11.8 11.8 0 01-1.604 1.194c-.161.093-.327.18-.494.263a1 1 0 01-1.127 0c-.167-.083-.333-.17-.494-.263a10.5 10.5 0 01-1.636-1.194 10.4 10.4 0 01-2.935-7.816.175.175 0 01.033-.11.175.175 0 01.12-.038c.08.001.16.001.24.001h1.063c.004 0 .008 0 .012-.001a16.7 16.7 0 001.687-6.213.176.176 0 01.106-.213.176.176 0 01.213.106c.16.285.334.56.521.826a16.7 16.7 0 001.686 6.213c.004.001.008.001.012.001h1.063c.004 0 .008 0 .012-.001a16.7 16.7 0 001.687-6.213.176.176 0 01.106-.213.176.176 0 01.213.106c.16.285.334.56.521.826a16.7 16.7 0 001.686 6.213c.004.001.008.001.012.001h1.063c.08 0 .16 0 .24-.001a.175.175 0 01.12.038.175.175 0 01.033.11z" clipRule="evenodd" />
                        )}
                      </svg>
                    </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-linear-to-r from-mint-leaf-500 to-bright-teal-blue-500 text-white font-zalando-expanded-bold py-3 px-6 rounded-xl hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                Send Message
